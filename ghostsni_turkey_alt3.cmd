@echo off
title GhostSNI - DNS kapali + QUIC kapali (oyun uyumlu)
...
if exist "%~dp0bin\GhostSNI.exe" (
    start "" "%~dp0bin\GhostSNI.exe" -f 2 -e -b -p -r -s -m
    goto :started
)
if exist "%~dp0build\GhostSNI.exe" (
    start "" "%~dp0build\GhostSNI.exe" -f 2 -e -b -p -r -s -m
    goto :started
)
if exist "%~dp0GhostSNI.exe" (
    start "" "%~dp0GhostSNI.exe" -f 2 -e -b -p -r -s -m
    goto :started
)
...
echo  Profil: DNS kapali + QUIC kapali (oyun uyumlu)
echo.
