@echo off
title GhostSNI - Buyuk fragment (4 byte) + oyun uyumlu
...
if exist "%~dp0bin\GhostSNI.exe" (
    start "" "%~dp0bin\GhostSNI.exe" -f 4 -e -b -p -r -s -m
    goto :started
)
if exist "%~dp0build\GhostSNI.exe" (
    start "" "%~dp0build\GhostSNI.exe" -f 4 -e -b -p -r -s -m
    goto :started
)
if exist "%~dp0GhostSNI.exe" (
    start "" "%~dp0GhostSNI.exe" -f 4 -e -b -p -r -s -m
    goto :started
)
...
echo  Profil: Buyuk fragment (4 byte) + oyun uyumlu
echo.
