...
if exist "%~dp0bin\GhostSNI.exe" (
    start "" "%~dp0bin\GhostSNI.exe" -f 2 -e -b -q -p -r -s -m --dns-addr 77.88.8.8 --dns-port 53
    goto :started
)
if exist "%~dp0build\GhostSNI.exe" (
    start "" "%~dp0build\GhostSNI.exe" -f 2 -e -b -q -p -r -s -m --dns-addr 77.88.8.8 --dns-port 53
    goto :started
)
if exist "%~dp0GhostSNI.exe" (
    start "" "%~dp0GhostSNI.exe" -f 2 -e -b -q -p -r -s -m --dns-addr 77.88.8.8 --dns-port 53
    goto :started
)
