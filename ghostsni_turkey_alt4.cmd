@echo off
title GhostSNI - Sabit TTL=3 + DNS kapali + QUIC kapali
...
if exist "%~dp0bin\GhostSNI.exe" (
    start "" "%~dp0bin\GhostSNI.exe" -f 2 -e --ttl 3 -p -r -s -m
    goto :started
)
if exist "%~dp0build\GhostSNI.exe" (
    start "" "%~dp0build\GhostSNI.exe" -f 2 -e --ttl 3 -p -r -s -m
    goto :started
)
if exist "%~dp0GhostSNI.exe" (
    start "" "%~dp0GhostSNI.exe" -f 2 -e --ttl 3 -p -r -s -m
    goto :started
)
...
echo  Profil: Sabit TTL=3 + DNS kapali + QUIC kapali
echo.
